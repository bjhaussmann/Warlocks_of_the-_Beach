...
/**
 * @author bjhau author Cesar 
 * 		   GameSpace is a parent object of the four types of
 *         items. They will have the mReturnType method to return its String
 *         name. The children objects call upon the super constructor to assign
 *         the appropriate String name. The idea is to have the class as a super
